...
public class MyConnectorEvent {
  private final EmailWatchServiceSubscriptionEvent event;

  public MyConnectorEvent(EmailWatchServiceSubscriptionEvent event) {
    this.event = event;
  }

  public EmailWatchServiceSubscriptionEvent getEvent() {
    return event;
  }
